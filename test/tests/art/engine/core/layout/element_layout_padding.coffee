...
], (chai, Foundation, Atomic, Elements, StateEpochTestHelper) ->
  {assert} = chai
    ...
    suite "layout", ->
      suite "padding", ->
        ...
        suite "layout", ->
          ...
          test "draw child with parent padding", (done)->
            parent = new Element
              size: 100
              padding: 10
              name: "parent"
          ...
          test "rectangle with padding", (done)->
            parent = new Element
              size: 100
              padding: 10
              name: "parent"
          ...
          test "padding and child-relative layout", (done)->
            parent = new Element
              size: wcw:1, h:100
              padding: 10
              childrenLayout: "flow"
          ...
          test "padding and TextElement", (done)->
          ...
          test "padding, TextElement, and child-relative size", (done)->
            parent = new TextElement
              align: "center"
              axis: .5
              location: ps: .5
          ...
          test "relayout child of a parent with padding", (done)->
            parent = new Element
                size: 100
                padding: 20
          ...
          test "parent with 4-part padding", (done)->
            ...
            grandParent.toBitmap area: "logicalArea", (bitmap)->
              log bitmap
          ...
          test "regression - different top and bottom", (done)->
            grandParent = new Element
              size: cs: 1
              name: "gp"
