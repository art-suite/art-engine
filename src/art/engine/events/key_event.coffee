define [
  ...
  keyCodesToKeys = []
  keyCodesToKeys[v] = k for k, v of keysToKeyCodes

  class KeyEvent extends Events.Event
    @keysToKeyCodes: keysToKeyCodes
    @keyCodesToKeys: keyCodesToKeys
    @keysDown = {}
    @keysDown.length = 0
