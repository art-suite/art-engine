define [
  ...
  'lib/art/engine/events/gesture_recognizer'
], (Foundation, Atomic, EventEpoch, Element, GestureRecognizer) ->
  ...
  createWithPostCreate class PagingScrollElement extends Element
